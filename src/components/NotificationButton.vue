<template>
  <div class="relative">
    ...
    <div
      ...
      <div v-if="dropdown.length" class="h-500 w-500 overflow-y-scroll">
        <div
      ...
      <div v-else class="text-center p-6 flex flex-col justify-center items-center h-500 w-500 overflow-y-scroll">
        <div>
